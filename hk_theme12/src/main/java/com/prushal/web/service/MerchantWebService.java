...
import com.prushal.exception.FileStorageException;
import com.prushal.model.DocumentUploads;
import com.prushal.model.Mail;
...
import com.prushal.repository.MerchantReduceLimitRepository;
import com.prushal.repository.MerchantRepository;
import com.prushal.repository.MerchantTopupLimitRepository;
import com.prushal.repository.NotificationRepository;
import com.prushal.repository.PotentialMerchantsRespository;
import com.prushal.repository.TerminalRepository;
import com.prushal.rest.service.EmailService;
import com.prushal.rest.service.ProjectService;
import com.prushal.rest.service.TerminalService;
import com.prushal.util.ErrorCodes;
import com.prushal.util.GenerateID;
...
public class MerchantWebService {
	...
	public String sendMerchantCredentials(String projectID, String merchantID, String terminalID) {
		...
		String message = "Welcome to Prushal Technology. MID " + merchantID
		...
		try {
			...
			Mail mail = new Mail();
			mail.setFrom("support@prushal.com");
			mail.setTo(merchant.getEmailId());
			mail.setSubject("Welcome to Prushal Technology.");
