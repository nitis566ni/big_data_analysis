...
public class CustomerService {
	...
	public Customer createCustomer(@Valid Customer customerDetails) {
		...
		String message = "You have been registered successfully with Prushal Tech Pvt Ltd. User ID "
