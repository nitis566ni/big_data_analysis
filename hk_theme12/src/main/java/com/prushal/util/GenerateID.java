...
public class GenerateID {
	...
	public static String generateCustID(long cid) {
		...
		String customerID = "PRC" + StringUtils.leftPad(rNo, 11, "0");
		return customerID;
	}
	...
	public static String generateEmployeeID(long eid) {
		...
		String employeeID = "PRE" + StringUtils.leftPad(rNo, 11, "0");
		return employeeID;
	}
	...
	public static String generateOfferCode(long offerId, String offerTitle) {
		...
		String offerCode = "PRO" + trimmedtitle.substring(0, 4) + StringUtils.leftPad(rNo, 4, "0");
		return offerCode;
	}
