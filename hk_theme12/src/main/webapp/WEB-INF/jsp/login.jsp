	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-4 col-md-4 col-sm-4 col-xs-12">
				<div class="text-center m-b-md custom-login">
					<h3>PLEASE LOGIN TO PrushalTech Pvt. Ltd. ADMIN</h3>
					<br>
				</div>
				<div class="hpanel">
						...
						<form action="login" id="loginForm" method="POST">
							<div class="form-group">
								<label class="control-label" for="username">Username</label> <input
									...
									title="Please enter you Username" required name="username"
							...
							<div class="form-group">
								<label class="control-label" for="password">Password</label> <input
									...
									placeholder="******" required name="password" id="password"
		...
		<div class="row">
			<div class="col-md-12 col-md-12 col-sm-12 col-xs-12 text-center">
				<p>
					A Trademark Product Of <a href="https://prushal.com/"
						target="_blank">Prushal Technologies Pvt. Ltd.</a> All
					rights reserved.
				</p>
			</div>
		</div>
